...
| [Mean Barchart](examples/barchart/) | [xxx](http://bl.ocks.org/Saigesp/xxx) | ![MeanBarchart](https://github.com/Saigesp/d3graphs/blob/master/examples/barchart-mean/thumbnail.png?raw=true) |
